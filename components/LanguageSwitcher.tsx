...
const translations: Record<string, string> = {
  ...
  "Una landing page completa, senza costi nascosti.": "A complete landing page, with no hidden costs.",
  "Per una landing page professionale parto da 400 €. Prima di iniziare analizziamo insieme attività, obiettivi e materiali disponibili. Ricevi poi un preventivo chiaro con tutto ciò che realizzerò, le tempistiche e il prezzo definitivo.": "Professional landing pages start from €400. Before we begin, we review your business, goals and available materials together. You then receive a clear quote covering everything I will deliver, the timeline and the final price.",
  "Investimento di partenza": "Starting investment",
  "Per una landing page professionale completa. Gli eventuali costi annuali di dominio o servizi esterni restano separati e sempre indicati prima dell'inizio.": "For a complete professional landing page. Any annual domain or third-party service costs remain separate and are always stated before work begins.",
  "Richiedi una valutazione gratuita": "Request a free assessment",
  "Cosa include il progetto": "What the project includes",
  "Analisi iniziale dell'attività": "Initial business analysis",
  "Organizzazione strategica dei contenuti": "Strategic content organisation",
  "Miglioramento e revisione dei testi": "Copy improvement and editing",
  "Design personalizzato sulla tua identità": "Custom design aligned with your identity",
  "Ottimizzazione per mobile, tablet e desktop": "Optimisation for mobile, tablet and desktop",
  "Collegamento e configurazione del dominio": "Domain connection and setup",
  "Pubblicazione definitiva del sito": "Final website publishing",
  "Pulsanti telefono, WhatsApp, Instagram e Google Maps": "Phone, WhatsApp, Instagram and Google Maps buttons",
  "Inserimento di orari, contatti e informazioni utili": "Business hours, contact details and key information",
  "SEO locale essenziale": "Essential local SEO",
  "Configurazione di Google Analytics": "Google Analytics setup",
  "Favicon, title e metadati essenziali": "Favicon, page title and essential metadata",
  "Cookie banner essenziale": "Essential cookie banner",
  "Due cicli di modifiche": "Two revision rounds",
  "Consegna di tutti gli accessi": "Handover of all account access",
  "30 giorni di assistenza tecnica dopo la pubblicazione": "30 days of technical support after launch",
  ...
  "Le landing page professionali partono da 400 €. Il prezzo finale dipende da struttura, contenuti, integrazioni e livello di personalizzazione. Dopo la prima conversazione ricevi un preventivo chiaro prima di iniziare qualsiasi lavoro.": "Professional landing pages start from €400. The final price depends on structure, content, integrations and level of customisation. After our first conversation, you receive a clear quote before any work begins.",
